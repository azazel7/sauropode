...
-- }}}
-- {{{ Wallpaper
--Sert à lister les fichiers d'un repertoire. La case 0 contient le nombre de fichier lu
...
function changer_wallpaper()
	beautiful.wallpaper = scandir(directory_walllpaper)
	for s = 1, screen.count() do
		local index_wallpaper = math.random(1, beautiful.wallpaper[0])
		gears.wallpaper.maximized(beautiful.wallpaper[index_wallpaper], s, true)
	end
