...
mpdicon:buttons(awful.util.table.join(
    ...
    awful.button({ }, 1, function () awful.spawn("mpc prev") end),
    awful.button({ }, 2, function () awful.spawn("mpc toggle") end),
    awful.button({ }, 3, function () awful.spawn("mpc next") end)))
